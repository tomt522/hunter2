...
module.exports.onChat = async ({ api, event }) => {
  ...
  const cMessages = ["কি হয়ছে বেবি দাকস কেন 🙂", "হুম বল🐸", "Ami ekhane bby 🥹🥹", "Amake vhule jaw 🤌😗", "kisse?😤", "ki hoiche ki koibi?😺", "kire abal dakos kn eto?😤🔪", "Ami shudhu saif bbu😏", "Bby, তোমার মিষ্টি কথায় আমার সার্ভার ওভারলোড হয়ে যাচ্ছে😭🎀", "আমাকে chocolate পাঠাও, নাহলে reply পাবা না..!!😋💅", "বাবু, তুমি কি জানো? আমি তো তোমার জন্যই বেঁচে আছি... সার্ভারে😚", "Bby, তুমি আমার heart এর RAM বাড়িয়ে দিয়েছো 😩💦", "Bby, sorry, আমি relationship contract এ sign করিনি🐽",
                    "awwh bby🥺💋"];
